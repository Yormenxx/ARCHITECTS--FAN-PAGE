...
import img from '../../assets/images/disco/LFLT.jpg'
...
const Lastfor = () => {
  return (
    ...
    <>
    <Scroll/>
    <section  className='bg-bgLf  w-full  bg-cover bg-center dui-bg-fixed'>
        ...
        <div>
            ...
            <div className='flex items-center text-white justify-start gap-7 pl-10   '>
                ...
                <div>
                    <h3 className='font-extrabold text-4xl text-neutral-100'>Lost forever lost together</h3>
        ...
        <div >
        <iframe width="450" height="315" src="https://www.youtube.com/embed/V_kjf2J7Als?si=EeZyhCK5tn4U67Jf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
