...
import img from '../../assets/images/disco/FORTHOSE.jpg'
...
const Forthose = () => {
  return (
    ...
    <>
    <Scroll/>
    <section  className='relative w-full bg-bgFor  bg-cover bg-center dui-bg-fixed top-0'>
        ...
        <div >
            <div className='flex items-center text-white justify-start gap-7 pl-10   '>
                ...
                <div>
                    <h3 className='font-extrabold text-4xl text-neutral-950'>for those to wish to exists</h3>
            ...
            <div>
                <div className='flex flex-col items-center justify-center backdrop-blur-lg '>
                    <div >
                        <iframe width="450" height="315" src="https://www.youtube.com/embed/0omLTfoXjWw?si=vC1Us1n_ZntgvSol" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen >
                        </iframe>
                    </div>
