...
import img from '../../assets/images/disco/HOLLOWCROWN.jpg'
...
const Crown = () => {
  return (
    ...
    <>
    <Scroll/>
    <section  className='w-full bg-bgHc bg-cover  bg-center dui-bg-fixed'>
        ...
        <div >
            <div className='flex items-center text-white justify-start gap-7 pl-10   '>
                ...
                <div>
                    <h3 className='font-extrabold text-4xl text-neutral-200'>All our have abandoned us</h3>
        ...
        <div >
        <iframe width="450" height="315" src="https://www.youtube.com/embed/9ZulYaNlYMo?si=-Sxw7nRZ_pp1IJFm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
