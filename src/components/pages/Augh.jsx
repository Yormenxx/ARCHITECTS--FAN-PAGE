...
import img from '../../assets/images/disco/AOGHU.jpg'
...
const Augh = () => {
  return (
    ...
    <>
    <Scroll/>
    <section  className=' w-full bg-bgAough bg-cover  bg-center dui-bg-fixed'>
    ...
    <article className='backdrop-blur-3xl py-12'>
        ...
        <div >
            <div className='flex items-center text-white justify-start gap-7 pl-10   '>
                ...
                <div>
                    <h3 className='font-extrabold text-4xl text-neutral-950'>All our have abandoned us</h3>
            ...
            <a href='https://en.wikipedia.org/wiki/Architects_(British_band)' target='_blank' className='flex flex-col items-center justify-center text-neutral-700'>
                    <Info />
        ...
        <div >
        <iframe width="450" height="315" src="https://www.youtube.com/embed/LpMxRApFkkI?si=g3dz6lKnjmnLOLlg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
